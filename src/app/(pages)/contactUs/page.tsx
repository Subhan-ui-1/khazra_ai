...
export default function ContactUs({ onSuccess }: { onSuccess?: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSuccess(true);
    const url =
      "https://dev-kai-backend-production.up.railway.app/api/contact-us/contactUs";
      ...
      <section className="w-full px-4 lg:py-[60px] md:py-[50px] sm:py-[40px] py-[30px] text-[var(--Paragraph)] border-b-2 border-dashed">
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="md:max-w-[620px] w-full mx-auto">
            <button
              className="bg-[var(--Outline)] text-[var(--Heading)] px-6 py-3 rounded-full font-medium mb-6"
              style={{ fontSize: "var(--P1-size)" }}
            >
              Contact us
            </button>
            <h2
              className="text-[var(--Heading)] font-bold mb-4"
              style={{ fontSize: "var(--H3-size)" }}
            >
              Let's talk, we're here.
            </h2>
            <p className="mb-6" style={{ fontSize: "var(--P1-size)" }}>
              Questions? Send us a message and we will get back to you soon.{" "}
              <br />
            ...
            <div className="space-y-4">
              <div className="flex items-center bg-[var(--Placeholder)] p-3 rounded-xl shadow-sm gap-3">
                <div className="w-12 h-12 bg-[var(--Background)] rounded-lg p-3">
                  <img
                    src="https://res.cloudinary.com/dxxymlo0o/image/upload/v1750142767/mail_xv9phy.svg"
                    className="w-6 h-6"
                  />
                </div>
                <a
                  href="mailto:khazrasupport@gmail.com"
              ...
              <div className="flex items-center bg-white px-4 py-3 rounded-xl shadow-sm gap-3">
                <div className="w-12 h-12 bg-[var(--Background)] rounded-lg p-3">
                  <img
                    src="https://res.cloudinary.com/dxxymlo0o/image/upload/v1750142767/phone_cnnhmw.svg"
                    className="w-6 h-6"
                  />
                </div>
                <a
                  href="tel:+9212345678910"
                  className="text-[var(--Heading)]"
                  style={{
                    fontSize: "var(--P1-size)",
                    fontWeight: "var(--P1-weight)",
          ...
          <form
            ...
            className="bg-white rounded-2xl lg:p-8 md:p-6 p-4 shadow-md space-y-5 md:max-w-[580px] w-full min-h-[560px] h-full mx-auto"
          >
            {isSuccess ? (
              ...
              <>
                <div>
                  <label
                    className="block text-[var(--Heading)] mb-2"
                    style={{
                      fontSize: "var(--P1-size)",
                      fontWeight: "var(--P1-weight)",
                    }}
                  ...
                  <div className="flex items-center border border-[var(--Outline)] rounded-lg p-3 gap-3">
                    <img
                      src="https://res.cloudinary.com/dxxymlo0o/image/upload/v1750142767/user_ubiktc.svg"
                      className="w-6 h-6"
                    />
                    <input
                      type="text"
