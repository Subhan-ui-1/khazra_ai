          ...
          <table className="w-full">
            <thead className="bg-green-50">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-green-800">Fuel/Process</th>
            ...
            <tbody>
              <tr className="border-b border-green-100 hover:bg-green-50 transition-colors">
                <td className="px-6 py-4 text-sm text-green-800">B-001</td>
                <td className="px-6 py-4 text-sm text-green-800">Boiler</td>
                <td className="px-6 py-4 text-sm text-green-800">Main Plant</td>
                <td className="px-6 py-4 text-sm text-green-800">Natural Gas</td>
                <td className="px-6 py-4 text-sm text-green-800">567.3 tCO₂e</td>
                <td className="px-6 py-4 text-sm text-green-800">-8.2%</td>
              ...
              <tr className="border-b border-green-100 hover:bg-green-50 transition-colors">
                <td className="px-6 py-4 text-sm text-green-800">F-023</td>
                <td className="px-6 py-4 text-sm text-green-800">Fleet Vehicle</td>
                <td className="px-6 py-4 text-sm text-green-800">Site A</td>
                <td className="px-6 py-4 text-sm text-green-800">Diesel</td>
                <td className="px-6 py-4 text-sm text-green-800">45.7 tCO₂e</td>
                <td className="px-6 py-4 text-sm text-green-800">-12.5%</td>
                <td className="px-6 py-4">
                  <span className="px-2 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full border border-green-800">
                    Monitored
                  </span>
              ...
              <tr className="border-b border-green-100 hover:bg-green-50 transition-colors">
                <td className="px-6 py-4 text-sm text-green-800">P-005</td>
                <td className="px-6 py-4 text-sm text-green-800">Process</td>
                <td className="px-6 py-4 text-sm text-green-800">Production Line 2</td>
                <td className="px-6 py-4 text-sm text-green-800">Chemical Process</td>
                <td className="px-6 py-4 text-sm text-green-800">234.1 tCO₂e</td>
                <td className="px-6 py-4 text-sm text-green-800">-5.8%</td>
                <td className="px-6 py-4">
                  <span className="px-2 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full border border-green-800">
                    Monitored
                  </span>
              ...
              <tr className="hover:bg-green-50 transition-colors">
                <td className="px-6 py-4 text-sm text-green-800">G-012</td>
                <td className="px-6 py-4 text-sm text-green-800">Generator</td>
                <td className="px-6 py-4 text-sm text-green-800">Backup Power</td>
                <td className="px-6 py-4 text-sm text-green-800">Diesel</td>
                <td className="px-6 py-4 text-sm text-green-800">23.4 tCO₂e</td>
                <td className="px-6 py-4 text-sm text-green-800">+2.1%</td>
                <td className="px-6 py-4">
