...
export default function StackedBarChart() {
    ...
    return (
        <div className="space-y-6 w-full shadow-md rounded-xl p-2 flex flex-col items-center justify-center">
            {/* Duration Switcher */}
            ...
            {/* Chart Display */}
            <div className="bg-white p-4 rounded-xl shadow-md border border-green-100 w-full flex">
                <Bar data={scopeChartData[duration]} options={options}/>
            </div>
        </div>
    );
}
