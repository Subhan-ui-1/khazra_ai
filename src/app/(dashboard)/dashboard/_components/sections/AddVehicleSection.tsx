...
const AddVehicleSection = ({ onComplete }: AddVehicleSectionProps) => {
  ...
  const startEdit = (item: any) => {
    ...
    const flattenedData = {
      ...
      electricityConsumptionValue:
        item.electricityConsumptionRate?.value?.toString() || "",
  ...
  const handleSelectAll = (checked: boolean) => {
    if (checked) {
      setSelectedVehicles(
        vehicleData.map((vehicle) => vehicle.id || vehicle._id)
      );
    } else {
      setSelectedVehicles([]);
    }
  ...
  const handleBulkDelete = async () => {
    if (
      !confirm(
        `Are you sure you want to delete ${selectedVehicles.length} selected vehicles?`
      )
    ) {
      return;
    }
  ...
  const handleBulkExport = async () => {
    try {
      ...
      toast.success(
        `${selectedVehicles.length} vehicles exported successfully`
      );
      setSelectedVehicles([]);
    } catch (error: any) {
                ...
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">
                    <input
                      type="checkbox"
                      checked={
                        selectedVehicles.length === vehicleData.length &&
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFormChange("modelYear", e.target.value)
                  }
                  required
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFormChange("purchaseYear", e.target.value)
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFormChange("secondaryFuelType", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("fuelConsumptionValue", e.target.value)
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFormChange("fuelConsumptionUnit", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("annualMileageValue", e.target.value)
                  }
                  placeholder="Enter value"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
                />
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFormChange("annualMileageUnit", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
                >
                  <option value="">Select unit</option>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("emissionCO2", e.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("emissionCH4", e.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("emissionN2O", e.target.value)
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFormChange("emissionStandard", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFormChange("averageSpeed", e.target.value)
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleFormChange("dataSource", e.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
                >
